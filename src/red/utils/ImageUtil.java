...
//                }
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi read data newboss");
        }
    }
...
//                System.out.println("frame id: " + frameId);
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi load datamob");
        }
    }
...
//            JOptionPane.showMessageDialog(null, null, "", zoom, new ImageIcon(oriImage));
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi read eff");
        }
    }
