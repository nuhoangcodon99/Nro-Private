...
//            System.out.println("check: " + check);
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi readmob");
        }
    }
...
//                }
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi readdatanewboss");
        }
    }
...
//                System.out.println("frame id: " + frameId);
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi readdatamob");
        }
    }
...
//            }
    ...
    public static void readEff(int id, int zoom) {
        try {
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi readeff");
        }
    }
    ...
    private static void readDataEffect(byte[] data, int idEffect, int zoom, BufferedImage oriImage) {
        try {
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi read data eff");
        }
    }
