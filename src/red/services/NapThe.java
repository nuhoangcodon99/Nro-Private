...
public class NapThe {
    ...
    public static final void SendCard(Player p, String loaiThe, String menhGia, String soSeri, String maPin) {
       String partnerId = "88121920118"; //0086879143
            String partnerKey = "39bfe91f134b1c94c71f0f136ff61cc2"; //edc3a8086e2db06925438495b0cf88df
...
//        
  ...
  Service.gI().sendThongBaoOK(p, "Gửi thẻ thành công \n"
    ...
    public static String MD5Hash(String input){
        ...
        e.printStackTrace();
        Logger.logException(Manager.class, e, "Lỗi nap the");
    }
    return null;
    }
