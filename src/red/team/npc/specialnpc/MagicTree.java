...
public class MagicTree {
    ...
    public static final short[] PEA_TEMP = {13, 60, 61, 62, 63, 64, 65, 352, 523, 595, 595};
    public static final int[] PEA_PARAM = {100, 500, 2, 4, 8, 16, 32, 64, 128, 256, 512};
    ...
    private static final short[][] PEA_UPGRADE = {
        ...
        {104, 4, 0, 300}, {200, 4, 0, 3000}, {0, 0, 0, 0}
    };
// {200, 4, 0, 3000} nâng cấp mất 300 ngày và , 4 giờ, 0 phút, và hết 3000 tức là 3 tỷ vàng
    //icon magic tree [gender][level]
    private static final short[][] ID_MAGIC_TREE = {
        {84, 85, 86, 87, 88, 89, 89, 89, 89, 89, 90},// thay id cây vào chỗ 1234
        {371, 372, 373, 374, 375, 376, 376, 376, 376, 376, 377},
        {378, 379, 380, 381, 382, 383, 383, 383, 383, 383, 384}};
    ...
    public void loadMagicTree() {
        ...
        try {
            ...
            String name = level > 10 ? "Đậu thần sì tai" : "Đậu thần cấp " + level;// đậu levo 11 có tên khác
